 ...
 * @LastEditTime: 2019-11-29 08:48:11
...
<template>
  <div class="comment-set-wrap page-wrap">
      ...
      <!-- 修改面板 -->
      <el-dialog :visible.sync="showEdit" width="400px"  :close-on-click-modal="false" :title ="`${dialogType=='edit'?'修改':'新增'}年级`">
...
export default {
    ...
    methods:{
        changeWeight (dir,id) {
          api.grade_change_weight({direction:dir,id})
          .then(data=>{
