 ...
 * @LastEditTime: 2019-11-27 10:20:18
...
<template>
  <div class="comment-set-wrap page-wrap">
      ...
      <!-- 修改面板 -->
      <el-dialog :visible.sync="showEdit" width="400px"  :close-on-click-modal="false" :title ="`${dialogType=='edit'?'修改':'新增'}课程类别`">
