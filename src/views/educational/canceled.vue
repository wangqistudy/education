 ...
 * @LastEditTime: 2019-12-05 15:16:12
              ...
              <el-tabs v-model="activeName" @tab-click="handleClick">
                <el-tab-pane label="学员信息" name="user">
                    <div class="exports-data">
                      <el-button type="primary" size="mini"  v-if="needSecret">导出数据</el-button>
                    </div>
                    <el-table
                      :data="userTableData"
...
export default {
    ...
    methods:{
        ...
        getLocalList () {
          this.setDataFilters(Object.assign({},this.dataFilters,{running_state:3}))
          this.getList()
        },
        handleClick (name) {
            //console.log(name)
