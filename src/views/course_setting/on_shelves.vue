 ...
 * @LastEditTime: 2019-12-04 16:10:15
                  ...
                  <div class="card-wrapper" v-for="(lesson,index) in tableData" :key="index" >
                    <lessonCard :info="lesson">
                      ...
                      <template slot="button" slot-scope="info">
                          <el-button type="primary"  size="mini"  @click="proxy_handleDelete(info.info.id,'doOffSale','下架该课程')" v-if="hasEditPermission">下架</el-button>
              ...
              <el-form :model="formData" ref="formData" :rules="formRule" label-width="130px" style="margin-top:20px;">
                ...
                <div class="inline">
                  <el-form-item label="课程编号:" prop="courser_sn">
                      <el-input v-model="formData.courser_sn" :disabled="true"></el-input>
                  </el-form-item>
                ...
                <div class="inline">
                  <el-form-item label="学期:" prop="semester_id">
                      <el-select v-model="formData.semester_id" :disabled="true">
                  ...
                  <el-form-item label="教学组:" prop="teacher_team_id" >
                      <el-select v-model="formData.teacher_team_id" :disabled="true">
                ...
                <div class="inline">
                  <el-form-item label="课程类别:" prop="course_type_id" >
                      <el-select v-model="formData.course_type_id" :disabled="true">
                  ...
                  <el-form-item label="科目:" prop="subject_id" >
                      <el-select v-model="formData.subject_id" :disabled="true">
                ...
                <div class="inline">
                  ...
                  <el-form-item label="年级:" prop="grade_id" >
                      <el-select v-model="formData.grade_id" :disabled="true">
                  ...
                  <el-form-item label="价格:" prop="source_price" >
                      <el-input style="width:85%;" v-model="formData.source_price" :disabled="true">
                ...
                <div class="inline">
                  ...
                  <el-form-item label="名额:" prop="total_num">
                      <el-input v-model="formData.total_num" :disabled="true"></el-input>
                  </el-form-item>

                  <el-form-item label="校区:" prop="school_id">
                      <el-select v-model="formData.school_id" :disabled="true">
                ...
                <div class="inline">
                  ...
                  <el-form-item label="教室:" prop="classroom_id">
                      <el-input v-model="formData.classroom_id" :disabled="true"></el-input>
                  </el-form-item>
                  <el-form-item label="座位安排:">
                      <el-input-number :controls="false" style="width:80px" v-model="formData.seat_row_num" :disabled="true"></el-input-number>
                      <span>行</span>
                      <el-input-number :controls="false" style="width:80px" v-model="formData.seat_column_num" :disabled="true"></el-input-number>
                      <span>列</span>
                  </el-form-item>
                </div>
                          ...
                          >
                            ...
                            <el-table-column
                              ...
                              >
                                ...
                                <template slot-scope="scope">
                                    <el-button size="mini" type="primary" @click="handleEditHour(scope.row,'edit')" :disabled="isEditValid(scope.row)">
                                      修改
                                    </el-button>
      ...
      <el-dialog :visible.sync="showEditTime" width="526px"  :close-on-click-modal="false" :title ="`${dialogType=='edit'?'修改':'新增'}课时`">
          ...
          <el-form :model="timeFormData" label-width="100px" :rules="timeFormRule" ref="timeFormData" class="timeformer">
              ...
              <el-form-item label="课时数" prop="hour_num">
                  ...
                  <el-input v-model="timeFormData.hour_num" :disabled="true"></el-input>
...
export default {
    ...
    data () {
      ...
      return {
        ...
        filterOptions:[
          ...
          // {  label:'上架时间:',filed:'online_date' , opt:'$eq' , options:[] , defaultValue:'' , type:'dateRange' , optionUrl:'' },
    ...
    computed :{
      getHourNum () {
        ...
        ...mapState({
          pathFilter:state=>state.redirect['/course_setting/on_shelves']
        })
    },
    filters:{
    filterSeconds (str) {
    ...
    methods:{
        ...
        getSearchList (id) {
          if (id) {
            ...
            this.getList();
            this.$router.replace('/course_setting/on_shelves')
          }else if (Object.keys(this.pathFilter).length>0) {
            
            let param = {};
            param = Object.assign({online_state:1},this.dataFilters,{online_date:this.pathFilter.timeRange,...this.pathFilter});
            if (param.timeRange) {
              delete param.timeRange
            }
            this.updatePathRedirect({
              path:'/course_setting/on_shelves',
              data:{}
            })
            this.getList(param);
          }else{
        ...
        isEditValid (row) {
          // 判断是否可以修改
          let startTime = row.class_date+' '+row.class_time_start;
          let startTimeTamp = new Date(startTime).getTime()
          let currStartTamp = new Date().getTime()
          try {
            if (startTimeTamp-currStartTamp<=5000) {
              return true;
            }
            else {
              return false;
        ...
        getLocalList () {
          this.setDataFilters(Object.assign({},this.dataFilters,{online_state:1}))
          this.getList()
        },
        handleRemote (query) {
        ...
        doOffSale (id) {
          ...
          api.course_off_sale({id})
          .then(data=>{
            this.getLocalList()
            this.$appmessage({
              type:'success',
              message:data.message||'下架成功'
            })
          })
        },
        doOnLine (id) {
